...
uint8_t chieu_trai,chieu_phai;

void write_driver(int16_t byte_reset, int16_t v_banh_trai,int16_t v_banh_phai)
{
    ...
    int16_t dir_left=chieu_trai;
    int16_t dir_right=chieu_phai;
    std::stringstream ss;
    ss << ", " << byte_reset<<" "<<dir_left<<" "<<v_banh_trai<<" "<<dir_right<<" "<<v_banh_phai<<".";
    // ROS_INFO("%d,%d,%d,%d,%d",byte_reset,dir_left,v_banh_trai,dir_right,v_banh_phai);
    // ROS_INFO("%d,%d",chieu_trai,chieu_phai);
